...
class ProductController extends Controller
{
    ...
    {
        $products = $this->product->filters($filters)->hasProductAttribute()->hasImages()->active()->activeUsers()->orderBy('order', 'desc')->simplePaginate(self::TAKE_MIN);
    ...
    public function search(Filters $filters)
    {
        ...
        }])->orderBy('order', 'asc')->simplePaginate(Self::TAKE_MIN);
