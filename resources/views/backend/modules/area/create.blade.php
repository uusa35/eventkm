    ...
    <div class="portlet box blue">
        ...
        <div class="portlet-body">
            ...
            <div class="portlet-body form">
                <form class="horizontal-form" role="form" method="POST" action="{{ route('backend.admin.area.store') }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group {{ $errors->has('code') ? ' has-error' : '' }}">
                                                <label for="code" class="control-label">{{ trans('general.code') }}
                                                    *</label>
                                                <input id="code" type="text" class="form-control" name="code"
                                                       value="{{ old('code') }}"
                                                       placeholder="{{ trans('general.code') }}" required autofocus>
                                                @if ($errors->has('code'))
                                                    <span class="help-block">
                                                <strong>
                                                    {{ $errors->first('code') }}
                                        ...
                                        @if(!requset()->has('governate_id'))
                                            <div class="col-md-6">
                                                @if(!$governates->isEmpty())
                                                    <div class="form-group">
                                                        <label for="duration"
                                                               class="control-label">{{ trans('general.governate') }}
                                                            *</label>
                                                        <select class="form-control input-xlarge" name="governate_id"
                                                                id="governate" required="required">
