        ...
        <div class="card">
            <span class="card-header">
                ...
                @if($element->receive_on_branch && $element->branch_id)
                    <span class="float-right"> <br><strong>{{ trans('general.receive_from_branch') }} : </strong> {{ trans('general.receive_from_branch') }} - {{ trans('general.branch') }}  : {{ $element->branch->name }}</span>
                @endif
